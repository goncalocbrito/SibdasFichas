    ...
    <header class="container-fluid bg-dark text-white">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-6 d-flex align-items-center p-3">
                <!-- Logo e Nome -->
                <a href="/SIBDAS/Ficha_12/isep_ginasio/private/home.php">
                    <img src="/SIBDAS/Ficha_12/isep_ginasio/private/assets/img/gym125_white.png"
            ...
            <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <a class="dropdown-item" href="/SIBDAS/Ficha_12/isep_ginasio/public/logout.php">
